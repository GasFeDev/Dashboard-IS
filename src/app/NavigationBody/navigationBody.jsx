...
import degaImg from "../Assets/degaImg.png";
...
const NavigationBody = () => {
  ...
  const handleButtonClick = () => {
    ...
    if (selectedToken !== "stETH" && selectedToken !== "stMATIC") {
      Swal.fire(CreateSwalProps("Observation", "Please connect your wallet."));
      return;
    }
  ...
  return (
    <>
      ...
      <img src={degaImg} alt="Descripción de la imagen" className="dega-img" />
    </>
  );
};
